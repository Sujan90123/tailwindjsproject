const products = [
    ...
    {
      name: 'Sony A7 Camera',
      src: '../images/sony_a7_camera.png',
      type: 'cameras',
      price: 1999.99,
    },
    {
      name: 'LG TV',
      src: '../images/lg_tv.png',
      type: 'televisions',
      price: 799.99,
    },
    {
      name: 'Nintendo Switch',
      src: '../images/nintendo_switch.png',
      type: 'games',
      price: 299.99,
    },
    {
...
products.forEach((product) => {
    const productElement = createProductElement(product); // Corrected here
      
    // Append each product element to the array and the DOM
    productElements.push(productElement);
    productsWrapperEl.appendChild(productElement);
  });
...
function createProductElement(product){
  ...
  function addToCart(e) {
    ...
    cartCount.innerText = cartItemCount.toString(); //update the item count;
